...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=.9\textwidth]{src/final_umt_perspective.png}
...
\begin{figure}[!ht]
    \centering
    \includesvg[width=\textwidth]{src/meas_vs_sim_gain_and_aperture_efficiency.svg}
    \caption{\label{fig:meas-vs-sim-gain-and-aperture-efficiency}Measurement results: gain and aperture efficiency}
\end{figure}

However, a considerable discrepancy is observed between the measured and simulated boresight gain, raising concerns regarding the accuracy of the radiation property measurements. Analysis of the anechoic chamber setup suggests a potential violation of the far-field condition. This condition requires the antenna under test (AUT) to be positioned at a distance greater than the \emph{Fraunhofer distance}, defined as
\begin{align}
...
\begin{figure}[!ht]
    \centering
    \includesvg[width=\textwidth]{src/meas_vs_sim_axial_ratio.svg}
    \caption{\label{fig:meas-vs-sim-axial-ratio}Measurement results: axial ratio}
\end{figure}

\Cref{fig:meas-vs-sim-sparameters,fig:meas-vs-sim-gain-and-aperture-efficiency,fig:meas-vs-sim-axial-ratio} present a selected portion of the comprehensive measurement dataset, which is fully documented in Appendix \ref{appendix:measurement-results}. This selective presentation was employed to maintain a focused discussion while ensuring a complete record of all acquired data readily accessible in the appendix. Specifically, the data showcased in these figures were extracted from Measurement Campaign 2, as detailed in Appendix \ref{appendix:measurement-results}.
...
This appendix compiles comprehensive measurement data from two campaigns conducted on the antenna prototype fabricated and tested by Universal Microwave Technology, Inc. Their contribution to realizing and characterizing the design is gratefully acknowledged. While key results are presented in the main text for comparison with simulations, this appendix provides a complete repository of all measured parameters, ensuring a concise presentation in the main body.

The data presented includes S-parameters measured using an Agilent VNA, providing insights into impedance matching and power transmission. Additionally, frequency responses of boresight gain and axial ratio, characterized in an in-house anechoic chamber using an open-ended waveguide as a sensing antenna, are included. Radiation patterns are presented as elevation and azimuth cuts at $\qty{5}{GHz}$, $\qty{5.3}{GHz}$, and $\qty{5.5}{GHz}$. \Cref{fig:final-ports} depicts the back view of the finalized antenna structure, clarifying the designation of Port 1 and Port 2, as well as the orientation of the spherical coordinate system employed for subsequent radiation pattern measurements.

\begin{figure}[!ht]
    \centering
    \includegraphics[width=.6\textwidth]{src/final_umt_ports.png}
    \caption{\label{fig:final-ports}Back view on the final structure}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{\label{fig:meas1-boresight-radiation}Measurement 1: boresight radiation}
\end{figure}
...
\begin{figure}[!ht]
    ...
    \caption{\label{fig:meas2-boresight-radiation}Measurement 2: boresight radiation}
\end{figure}
