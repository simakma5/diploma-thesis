...
\begin{remark}[Modal decomposition of guided waves]
    ...
    The equations for $E_z$ and $B_z$, \cref{subeq:guided-wave-longitudinal-fields}, are instances of the \emph{Helmholtz equation} with Dirichlet and Neumann boundary conditions, respectively. This mathematical structure is analogous to the eigenvalue problem for the Laplace operator, which arises in various physical contexts.
