...
\begin{figure}[!ht]
    ...
    \begin{subfigure}{.8\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/dual_feed_side_cut_view.png}
        \caption{\label{fig:dual-feed-side-cut-view}Side-cut view}
    \end{subfigure}
    \\[0.5cm]
    \begin{subfigure}{.4\textwidth}
        \centering
        \includegraphics[width=\textwidth]{src/dual_feed_front_view.png}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=\textwidth]{src/final_umt_perspective.png}
